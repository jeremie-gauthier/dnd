...
describe('UserConnectionUseCase', () => {
  ...
  beforeEach(async () => {
    ...
    userConnectionUseCase = app.get<UserConnectionUseCase>(UserConnectionUseCase);
    userConnectionRepository = app.get<UserConnectionRepository>(UserConnectionRepository);
  ...
  it('should emit an event when this is a new user', async () => {
    ...
    vi.spyOn(userConnectionRepository, 'shouldSetupUserEnvironment').mockImplementation(() =>
